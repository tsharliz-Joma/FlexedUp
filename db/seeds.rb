...
ul = User.create :name => "Julio Cesar Chavez", :image => "https://www.ringtv.com/wp-content/uploads/2012/02/file_171349_1_Julio_Cesar_Chavez.jpg", :email => "lightweight@ga.com", :password => "chicken", :favourite => "Big F",
